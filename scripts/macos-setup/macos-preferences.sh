...
sudo scutil --set ComputerName "bbMini"
sudo scutil --set HostName "bbMini"
sudo scutil --set LocalHostName "bbMini"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "bbMini"
...
defaults write com.apple.dock wvous-tr-modifier -int 0
# Bottom left screen corner → Launch
defaults write com.apple.dock wvous-bl-corner -int 11
defaults write com.apple.dock wvous-bl-modifier -int 0
# Bottom right screen corner → Desktop
defaults write com.apple.dock wvous-br-corner -int 4
defaults write com.apple.dock wvous-bl-rodifier -int 0
